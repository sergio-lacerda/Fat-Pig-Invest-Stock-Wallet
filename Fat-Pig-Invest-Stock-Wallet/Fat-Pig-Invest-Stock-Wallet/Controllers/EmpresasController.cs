...
namespace Fat_Pig_Invest_Stock_Wallet.Controllers
{
    public class EmpresasController : Controller
    {
        ...
        public EmpresasController(FatPigInvestContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Empresas != null ? 
                          ...
                          Problem("Entity set 'FatPigInvestContext.Empresas'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'FatPigInvestContext.Empresas'  is null.");
            }
            var empresa = await _context.Empresas.FindAsync(id);
            if (empresa != null)
            {
